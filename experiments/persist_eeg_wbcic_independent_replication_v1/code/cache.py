...
EXP_ROOT = REPO_ROOT / "experiments" / "persist_eeg_wbcic_independent_replication_v1"
OUT = EXP_ROOT
PROTOCOL = EXP_ROOT / "provenance"
CACHE = EXP_ROOT / "runtime" / "cache" / "wbcic_epochs"
...
IMPLEMENTATION_ID = "persist_eeg_wbcic_independent_replication_v1_20260826"
SESSIONS = (0, 1, 2)
...
def build(raw_root: Path, workers: int, batch_size: int) -> dict[str, Any]:
    ...
    audit = {
        ...
        "materialized_subjects_hash": sha_lines(subjects),
        "materialized_subjects_hash_order": "development-scope order",
        "materialized_subjects_set_equals_allowed": materialized == set(subjects),
