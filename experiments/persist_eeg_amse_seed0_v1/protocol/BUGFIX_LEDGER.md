...
- 2026-09-09: default REPO inference used parents[2] (experiments directory); corrected to parents[3] (repository root). Environment-overridden execution path and numerical results unchanged.
