"""Checkpoint-native TRAIN-only PERSIST discovery on an EEGNet replica epoch v3.
...
def main() -> None:
    ...
    result = cell / "checkpoint_native_pt_v3" / f"epoch_{epoch:03d}.json"
    ...
    try:
        ...
        print("NATIVE_PT_V3_COMPLETE", task, fold, epoch, "rank", len(protected), flush=True)
