...
$entry=Join-Path $exp 'code\build_first_cell_compact_preview_v1.py'
$preview=Join-Path $runtime 'compact_preview\eegnet_openbmi_mi_fold0_seed0_v1'
$log=Join-Path $runtime 'scheduled_first_cell_compact_preview_EEGNet_OpenBMI_MI_f0_v1.log'
...
try {
  ...
  if((Get-FileHash -LiteralPath $entry -Algorithm SHA256).Hash.ToLowerInvariant() -ne '63001e966f814facaac6fe74a49127c6b83d2cbb4915ae8822751c3ca3fee2f5') {throw 'compact-preview source SHA mismatch'}
