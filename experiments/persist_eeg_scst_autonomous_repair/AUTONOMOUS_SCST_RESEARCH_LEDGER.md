...
| Repair-R2 | R1 global task-protected map remained locally heterogeneous and class-unsafe | source-only OpenBMI/WBCIC only | protocol committed; source run pending |
