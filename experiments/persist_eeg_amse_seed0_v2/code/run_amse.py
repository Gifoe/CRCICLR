...
def lock_only(device: torch.device) -> None:
    ...
    entries = []
    for p in (PROTOCOL / "AMSE_MODEL_SPEC.json", PROTOCOL / "TRAINING_PROTOCOL.json", PROTOCOL / "SPLIT_PROVENANCE.json", PROTOCOL / "REFERENCE_PROVENANCE.json", PROTOCOL / "OUTCOME_VISIBILITY_AUDIT.json", PROTOCOL / "SMOKE_TEST.json", PROTOCOL / "STABLE_EXACTNESS_TEST.json", PROTOCOL / "GRADIENT_FIREWALL_TEST.json"):
