...
$log = Join-Path $env:NEW_BASELINE_RUNTIME "train_queue_$Model.log"
...
Set-Content -LiteralPath (Join-Path $env:NEW_BASELINE_RUNTIME "train_queue_${Model}_exit.txt") -Value "$code"
exit $code
