...
def main() -> None:
    ...
    lock={"schema":"FM_RESCUE_STAGE0_PROTOCOL_LOCK_V1","created_at_code_commit":c.git_head(),"frozen_before_primary_outcomes":True,
        "data_access_lock_sha256":c.sha256(c.PROTOCOL/"DATA_ACCESS_LOCK.json"),"fm_input_protocol_lock_sha256":c.sha256(c.PROTOCOL/"FM_INPUT_PROTOCOL_LOCK.json"),"code_hashes":code_hashes,
        ...
        "representation":"official final encoder representation used by head; 200-D; no layer search",
